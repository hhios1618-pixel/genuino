...
export const workedSongs = [
  ...
  {
    title: "Pelota Parada — TNT Sports Chile",
    artist: "Antonio Ríos",
    role: "Gestión / booking TV",
    outcome: "Gestión de aparición en Pelota Parada, TNT Sports Chile — colocación en medio de alcance nacional.",
    videoId: "lgo_FxrWILk",
    href: "https://www.youtube.com/watch?v=lgo_FxrWILk",
    tags: ["TV", "Gestión", "Medios"],
    featured: true,
  },
  {
    title: "Me siento amado en Chile — Bio Bio",
    artist: "Antonio Ríos",
    role: "Gestión / booking medios",
    outcome: "Entrevista en Bio Bio Chile, posicionamiento en prensa digital y radio con alcance masivo.",
    videoId: "TMhuls1tWnU",
    href: "https://www.youtube.com/watch?v=TMhuls1tWnU",
    tags: ["Prensa", "Gestión", "Medios"],
    featured: true,
  },
  {
